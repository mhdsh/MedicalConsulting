...
namespace MedicalConsulting.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public MessagesController(IConsultingRepository repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId)
        {
            ...
            var messageFromRepo = await _repo.GetMessageThread(userId);
        ...
        [HttpGet("thread")]
        public async Task<IActionResult> GetMessageThreadForAdmin(int userId)
        {
            
            var messageFromRepo = await _repo.GetMessageThreadForAdmin(userId);
        ...
        [HttpPost("user")]
        public async Task<IActionResult> CreateMessageForUser(int userId, MessageForCreationDto messageForCreationDto)
        {
